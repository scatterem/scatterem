...
The Warp counterpart of
:func:`scatterem2.utils.aberration_basis.cartesian_chi`, written from the same
expansion and validated against it.
...
:data:`scatterem2.utils.aberration_basis.COEFFICIENT_NAMES`::
