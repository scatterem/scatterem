...
from scatterem2.utils.utils import CopyMixin
...
class Accelerator(CopyMixin):
    ...
    def check_is_defined(self) -> None:
        """
    ...
    def check_match(self, other: Accelerator | HasAcceleratorMixin) -> None:
        """
...
class HasAcceleratorMixin:
    ...
    @accelerator.setter
    def accelerator(self, new: Accelerator) -> None:
